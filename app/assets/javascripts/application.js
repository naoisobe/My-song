...
let saveAudio = function () {
  downloadLink.href = exportMP3(audioData);
...
let exportMP3 = function (audioData) {
  ...
  let dataview = encodeMP3(mergeBuffers(audioData), audio_sample_rate);
  let audioBlob = new Blob([dataview], { type: 'audio/mp3' });
